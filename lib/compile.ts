...
import { CustomTransform, FilledAutolinkOptions, BuildInTransforms, AutolinkOptions, AutolinkTransforms } from "./interfaces";
...
export function compile(
  ...
  const compiledTransforms = transforms.map(t => compileTransform(t, filledOptions));
  return {
      [compiledSettingMarker]: true,
